...
public class ArticleController {
    ...
    @GetMapping("/articles/{id}/delete")    /*delete를 지원안해서 getMapping함. */
    public String delete(@PathVariable Long id, RedirectAttributes rttr) {   /*id Long 값이 url 대입이 되기 위해서는 @PathVariable이 필요*/
        ...
        }   //addFlashAttribute 한번 쓰고는 사라지는 휘발성 데이터
